...
for i in range(len(MCF7_pred)):
  print(MCF7_pred[i])
  path = "src/HiCSeg_SpectralTAD_res/MCF7/{fname}/spec_res.csv" #change 7 to 10a
  pred = []
...
#   print(MCF7_pred[i])
  truth = []
  path = "data/GSE66733_Hi-C_MCF7_MCF10A_processed_HiCfiles_domains/TAD_boundaries/HiCStein-MCF7-WT__hg19__{fname}__C-40000-iced.is1000000.ids240000.insulation.boundaries"
  with open(path.format(fname = MCF7_pred[i]))as f:
    for line in f:
